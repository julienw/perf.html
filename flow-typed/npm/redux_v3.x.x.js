...
declare module 'redux' {
  ...
  */
  ...
  declare type PlainDispatchAPI<A> = (action: A) => A;
  declare type ThunkDispatchAPI<S, A> = <R>(action: ThunkAction<S, A, R>) => R;
  declare type Dispatch<S, A: { type: $Subtype<string> }> = PlainDispatchAPI<
    A
  > &
    ThunkDispatchAPI<S, A>;
